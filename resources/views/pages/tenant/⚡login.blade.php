...
<div class="flex justify-center items-center h-[calc(100vh-64px)]">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
        ...
        <a href="/auth/google/redirect" class="flex items-center justify-center gap-3 w-full border-2 border-gray-200 py-3 px-4 rounded-xl hover:bg-gray-50 transition-colors font-bold text-gray-700">
